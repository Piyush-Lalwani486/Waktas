      ...
      <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-3 md:py-4">
        <div className="flex items-center justify-between">
          <Link to="/" onClick={() => window.scrollTo(0, 0)} className="flex items-center gap-2 sm:gap-3 touch-manipulation">
            <img src={cloudiLogo} alt="Cloudi Logo" className="h-8 sm:h-10 md:h-12 lg:h-14 xl:h-16 w-auto object-contain max-w-[120px] sm:max-w-[140px] md:max-w-[160px] lg:max-w-[180px]" />
            
          </Link>
          
          <nav className="hidden md:flex space-x-2 md:space-x-3 lg:space-x-6 xl:space-x-8 items-center">
